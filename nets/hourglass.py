...
class exkp(nn.Module):
    def __init__(self, n, nstack, dims, modules, cnv_dim=256, num_classes=80, is_training=True):
...
def get_hourglass(model_name, num_classes=80, is_training=True):
    nstack = 2
    if model_name == 'small_hourglass':
        nstack = 1
    return exkp(n=5, nstack=nstack,
